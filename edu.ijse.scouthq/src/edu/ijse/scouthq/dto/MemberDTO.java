 ...
 */
public class MemberDTO extends SuperDTO implements Serializable{
    ...
    public MemberDTO(String regId, String nameInit, String nameFull, String dateOfBirth, String address, String tp,String sclId, String joiningDate, String registedDate) {
        this.regId = regId;
    ...
    public MemberDTO(String regId, String nameInit, String nameFull, String dateOfBirth, String address, String tp, String sclId, String joiningDate, String registedDate, RegistrationCategoryDTO regCatDTO) {
        this.regId = regId;
        this.nameInit = nameInit;
        this.nameFull = nameFull;
        this.dateOfBirth = dateOfBirth;
