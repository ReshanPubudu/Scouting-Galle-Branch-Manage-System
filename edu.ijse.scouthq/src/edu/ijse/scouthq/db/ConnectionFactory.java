...
public class ConnectionFactory {
    ...
    private ConnectionFactory() {
        ...
        String url = "jdbc:mysql://"+ dbProperties.getProperty("ip") + ":"+ dbProperties.getProperty("port") + "/"+ dbProperties.getProperty("database");
    ...
    public Connection getConnection() {
        //System.out.println("ConnectionFactory2");
